...
# Имя переменной записывается в нижнем регистре (lowercase).
...
class CoursesDetailView(TemplateView):
    ...
    def get_context_data(self, pk=None, **kwargs):
        # Создание лог-сообщений через созданный объект
        logger.debug("log message: open page 'courses_detail.html'")

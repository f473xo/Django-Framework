...
# Тест рассмотривает два случая:
# 1. Кнопка, которая появляется на странице, кликабельная (clickable).
# 2. Цвет элемента соответствует заданному (извлечение CSS-свойства)
